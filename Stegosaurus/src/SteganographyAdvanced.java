...
public class SteganographyAdvanced {
	...
	public static void encrypt() {
		...
		maxVal = img.getWidth()*img.getHeight();
	...
	static HashSet<Integer> pointSet;
	...
	public static void main(String[] args) {
		...
		random = new SecureRandom(secretKey);
